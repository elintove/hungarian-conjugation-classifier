...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train a Random Forest classifier on Hungarian conjugation embeddings."
    )
    ...
    parser.add_argument("--model-dir", type=Path, default=Path("models/random_forest"))
    parser.add_argument(
        "--embedding-model",
